    ...
    if usr_cmd == "/start":
        ...
        await cmd.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("Support Group", url="https://t.me/gotMovieslink"),
                        InlineKeyboardButton("Channel", url="https://t.me/gtwebseries")
                    ],
                    [
        ...
        try:
            ...
            await send_stored_file.reply_text(
                f"**Here is Sharable Link of this file:** https://t.me/{Config.BOT_USERNAME}?start=Moviestrix_{file_id}\n\n__To Retrive the Stored File, just open the link!__",
...
async def main(bot: Client, message: Message):
    if message.chat.type == "private":
        ...
        if message.from_user.id in Config.BANNED_USERS:
            await message.reply_text("Sorry, You are banned!\n\nContact [Support Group](https://t.me/gotMovieslink)",
                                     disable_web_page_preview=True)
            return
        ...
        try:
            ...
            share_link = f"https://t.me/{Config.BOT_USERNAME}?start=Moviestrix_{file_er_id}"
            await editable.edit(
                f"**You Stored File in Moviestrix Database!**\n\nHere is the Permanent Link of your file: {share_link} \n\nJust Click the link to get your file!",
                parse_mode="Markdown",
                reply_markup=InlineKeyboardMarkup(
                    [[InlineKeyboardButton("Your Link", url=share_link)],
                     [InlineKeyboardButton("Developer", url="https://t.me/TargetX25"),
                      InlineKeyboardButton("Discussion Group", url="https://t.me/gotMovieslink")]]
                ),
                disable_web_page_preview=True
            )
    ...
    if "aboutbot" in cb_data:
        await cmd.message.edit(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("Touch it",
                                             url="https://telegra.ph/What-are-u-doing-here-06-04")
                    ],
                    [
        ...
        if Config.UPDATES_CHANNEL:
            ...
            try:
                ...
                await cmd.message.edit(
                    text="Something went Wrong. Contact my [Support Group](https://t.me/gotMovieslink).",
                    parse_mode="markdown",
                    disable_web_page_preview=True
                )
                return
